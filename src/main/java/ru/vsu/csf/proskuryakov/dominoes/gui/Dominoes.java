...
import ru.vsu.csf.proskuryakov.dominoes.data.command.CommandHistory;
...
public class Dominoes extends Application {
    ...
    public static void dominoesMain(String[] args) {
        launch(args);
    }
    ...
    private void initScenes() throws IOException {
        ...
        //game = new Scene(FXMLLoader.load(getClass().getClassLoader().getResource("fxml\\NewGame.fxml")));
